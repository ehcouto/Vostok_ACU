...
## Valid values are:
##      MKE1xF MKE1xZ RX130 RX210 STM32F0x STM32F1x STM32G0x
##
MICRO:=STM32G0x
...
##      to create Vostok_ACU_A_with_IAP_FVT.s19
## The FILE_MERGE_IAP file must be placed in the config/build folder.
##
#FILE_MERGE_IAP:=Vostok_IAP_A.s19
...
##      to create Vostok_ACU_A_with_FVT.s19
...
##
#FILE_MERGE_SF:=C:\GESE_Dishwasher_Integration\Application
...
## You may optionally specify parameters for the script.
##
#SCRIPT_AFTER_BUILD:= Merge_FW_with_IAP.bat
