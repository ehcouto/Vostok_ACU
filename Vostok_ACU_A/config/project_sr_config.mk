...
##
ALT_OPTIMIZATION:=-Oh
ALT_OPTIMIZATION_FILES:= Mci.c Mcl.c MciZeroCross.c MclFireAngleCtrl.c MclInputProc.c MclObserver.c MclTriacDrive.c MclZeroCross.c TimeCapture.c TimerInterruptExt.c PeakDetector.c Pi.c GlitchFilter.c MasterCommander.c mc_bdm.c mc_llmem.c mc_protocol.c mc_rec.c mc_scope.c mc_serial.c ZeroCross.c
